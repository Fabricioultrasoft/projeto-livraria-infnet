<%@ Page Language="C#" MasterPageFile="~/Site.master"  AutoEventWireup="true" CodeFile="Endereco.aspx.cs" Inherits="Endereco_Endereco" %>
...
<h1>Endereço</h1>
    ...
    <br />
    Logradouro:&nbsp; 
    <asp:TextBox ID="TbLogradouro" runat="server" Width="281px" 
